      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-2.5">
            <span className="flex h-7 w-7 items-center justify-center rounded-md bg-accent-600 font-mono text-xs font-bold text-white">
              MKQ
            </span>
        ...
        <div className="mt-6 flex flex-col items-center gap-2 text-xs text-slate-500 dark:text-slate-500">
          ...
          <p className="text-slate-400 dark:text-slate-600">
            © {new Date().getFullYear()} {SITE.name}. Built with React, TypeScript & Tailwind.
          </p>
        </div>
      </div>
    </footer>
