...
export default function App() {
  ...
  return <div className="editorial-site">
    ...
    <main>
      ...
      <section id="contact" className="contact-section dark-section"><div className="section-kicker" data-reveal>LET'S TALK / BUILD WITH INTENT</div><h2 data-reveal>CONTACT</h2><div className="contact-grid" data-reveal><p>Have a product that needs a careful QA pass or a team looking for someone who can think like a builder and tester?</p><div className="contact-links"><a className="magnetic" href={`mailto:${SITE.email}`}>EMAIL <ArrowUpRight /></a><a className="magnetic" href={SITE.links.github} target="_blank" rel="noreferrer"><Github /> GITHUB <ArrowUpRight /></a><a className="magnetic" href={SITE.links.linkedin} target="_blank" rel="noreferrer"><Linkedin /> LINKEDIN <ArrowUpRight /></a></div></div></section>
    </main>
